  ...
  return (
    <div className="flex flex-col p-4 pb-28 pt-6 gap-5">
      ...
      {viewingImage && (
        ...
        >
          {/* Close button */}
          <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white text-xl z-10 active:scale-90 transition-transform">
            ✕
          </button>
          {/* Hint */}
