...
export default function Charts() {
  const { allTransactions: transactions, totalExpense, totalIncome } = useExpenses();
    ...
    <div className="flex flex-col p-4 pb-28 pt-6 gap-6">
      ...
      <div className="flex gap-3">
        <div className="flex-1 bg-[#18181f] rounded-2xl p-4 border border-green-500/10">
          ...
          <p className="font-display font-bold text-green-400">{formatCurrency(totalIncome)}</p>
        </div>
        <div className="flex-1 bg-[#18181f] rounded-2xl p-4 border border-red-500/10">
          ...
          <p className="font-display font-bold text-red-400">{formatCurrency(totalExpense)}</p>
        </div>
      </div>
